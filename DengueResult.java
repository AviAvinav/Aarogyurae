 ...
 */
public class DengueResult extends javax.swing.JFrame {

    /**
     * Creates new form DengueResult
     */
    public DengueResult() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DengueResult.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new DengueResult().setVisible(true);
            }
        });
    }
